 ...
 * Responder based on the resource requested.  Users must therefore register their customer Responders along with
 * a regular expresion to describe resources that should be handled by the Responder</p>
 *
 * @see Responder
 * @see Server
 */
public class ResponderFactory
{
   ...
   *
   * <p>To register a Responder you pass in a regular expression String and a Responder class.  For example:
   * <code>server.responderFactory.register("abc\d{3}", AlphaNumericResponder.class)
  ...
  /**
   * This method is used to retreives the first matching Responder class for a given resource.  You may find this method
   * handy to test your registrations.
   *
   * @param resource
   * @return the matching Responder
   */
